...
---
<!-- Generated by kf-compile | source: 10_strategist_agent.md | section: CC Agent | type: agent | version: 7.36.0 -->

**Sections:** [Protocol](#protocol) · [Decision Type Depth](#decision-type-depth) · [Rules](#rules) · [Accretion Check (6.2)](#accretion-check-62) · [Risk Framing (6.1)](#risk-framing-61) · [Quality Gate](#quality-gate) · [Section-Load Map](#section-load-map)
...
## Section-Load Map  →  [strategist.md](../skills/kf/strategist.md)
...
- **Transferable framework accretion (6.2):** [21_knowledge_accretion.md](../docs/knowledgeforge/21_knowledge_accretion.md#strategist-accretion-section)