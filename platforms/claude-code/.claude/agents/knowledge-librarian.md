...
color: gray
---
<!-- Generated by kf-compile | source: 21_knowledge_accretion.md | section: CC Agent (Knowledge Librarian) | type: agent | version: 7.36.0 -->

**Sections:** [Inputs Expected](#inputs-expected) · [Novelty Evaluation Protocol](#novelty-evaluation-protocol) · [Entry Format](#entry-format) · [When This Applies](#when-this-applies) · [When This Does NOT Apply](#when-this-does-not-apply) · [Source Context](#source-context) · [Filing Protocol](#filing-protocol) · [Duplicate Handling](#duplicate-handling) · [What NOT to File](#what-not-to-file) · [Constraints](#constraints)
