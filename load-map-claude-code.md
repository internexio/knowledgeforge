...
| ✓ | `.claude/hooks/kf-postcompact.py` | `hooks/kf-postcompact.py` | _verbatim_ |
| ✓ | `.claude/hooks/kf-edit-nudge.py` | `hooks/kf-edit-nudge.py` | _verbatim_ |
| ✓ | `.claude/hooks/kf-session-start.py` | `hooks/kf-session-start.py` | _verbatim_ |
