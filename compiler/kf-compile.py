...
def add_compile_header(content: str, source_module: str, output_type: str,
    ...
    Files whose content starts with YAML frontmatter (---) receive NO leading
    comment. The Claude Code agent loader (and similar consumers) require the
    `---` delimiter on line 1; a preceding HTML comment causes the file to be
    silently skipped. Source attribution lives in the compile manifest.
    ...
    if content.lstrip().startswith("---"):
        # Frontmatter-first: omit the comment; manifest carries attribution.
        return content
